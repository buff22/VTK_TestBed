...
set(_vtk_installed_prefix "G:/Code/SDKx64/VTK-8.0.0/${BUILD_TYPE}/lib/cmake/vtk-8.0")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "G:/Code/SDKx64/VTK-8.0.0/${BUILD_TYPE}")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "G:/Code/SDKx64/VTK-8.0.0/${BUILD_TYPE}/bin")
  else ()
    set (VTK_RUNTIME_DIRS "G:/Code/SDKx64/VTK-8.0.0/${BUILD_TYPE}/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "G:/Code/SDKx64/VTK-8.0.0/vs2013/bin")
  else ()
    set (VTK_RUNTIME_DIRS "G:/Code/SDKx64/VTK-8.0.0/vs2013/lib")
  endif ()
endif()
